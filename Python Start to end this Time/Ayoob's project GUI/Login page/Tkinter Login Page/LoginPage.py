...
class LoginPage:
    def __init__(self, window):
        ...
        self.window.title('Group-18 REAL TIME BUG FIXING TIME ESTIMATION Login Page')
        ...
        # ========================================================
        # ========================================================================
        self.txt = "WELCOME TO REAL TIME BUG FIXING TIME ESTIMATION"
        self.heading = Label(self.lgn_frame, text=self.txt, font=('yu gothic ui', 15, "bold"), bg="#040405",
                             fg='white',
                             bd=5,
                             relief=FLAT)
        self.heading.place(x=100, y=30, width=700, height=30)
